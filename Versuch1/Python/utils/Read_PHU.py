# From: https://github.com/PicoQuant/PicoQuant-Time-Tagged-File-Format-Demos/blob/master/PHU/Python/Read_PHU.py
...
#inputfile = open('d:\Work\PL\Manuals, Software\_Self\TimeDataReader\Test.PHU', "rb")
#outputfile = open('d:\Work\PL\Manuals, Software\_Self\TimeDataReader\Test.txt', "w+")
inputfile =  open('c:\_d\Work\PL\Manuals, Software\_Self\TimeDataReader\data\Lebensdauer, P=10uW, t=1000s,S=20um,U=00V,10MHz,Ex bei 798,46nm.phu', "rb")
outputfile = open('c:\_d\Work\PL\Manuals, Software\_Self\TimeDataReader\data\Lebensdauer, P=10uW, t=1000s,S=20um,U=00V,10MHz,Ex bei 798,46nm.txt', "w+")
